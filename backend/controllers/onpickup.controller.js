...
import OnpicupItem from "../models/onpickup.model.js" // Import the CartItem model
...
export const addToCart = async (req, res) => {
  try {
    ...
    const cartItem = new OnpicupItem({
...
export const getProductListFromCart = async (req, res) => {
  try {
    ...
    const cartItems = await OnpicupItem.find();
...
//     const deletedProduct = await OnpicupItem.findByIdAndDelete(id);
...
export const deleteProductFromCart = async (req, res) => {
  const { cartItemId } = req.params; // Assuming the parameter is named cartItemId

  try {
      const deletedItem = await OnpicupItem.findByIdAndDelete(cartItemId);
