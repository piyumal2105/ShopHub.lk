          ...
          <center style={{ marginLeft: "-120px" }}>
            ...
            <div>
                        ...
                        <Col>
                          <DatePicker
                            ...
                            minDate={
                              selectedAddedDate
                                ? new Date(
                                    selectedAddedDate.getTime() +
                                      24 * 60 * 60 * 1000
                                  )
                                : null
                            } // Add 1 day to the selectedAddedDate
                            // {...register("endDate", {
                            //   //   required: true,
                            // })}
                          />
              ...
              <div style={{ padding: "30px" }}>
                ...
                <Table style={{ width: "75rem" }} striped bordered hover>
                  <thead>
                    <tr>
                      <th>Promotion ID</th>
